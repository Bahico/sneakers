...
export default [
  ...
  },
  {
    ...
    icon: `
      <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5.18351 8.64205V0H3.46404V8.64205H5.18351ZM8.6416 5.17756V3.4581H-0.000444412V5.17756H8.6416Z" fill="#222222"/>
      </svg>
    `
  },
  {
  ...
  {
    name: 'trash-outline-sm',
    icon: `
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4 3.42761L4 2.31328C4 1.53675 4 1.14849 4.23294 0.907253C4.46589 0.666016 4.84081 0.666016 5.59064 0.666016L7.74269 0.666016C8.49253 0.666016 8.86744 0.666016 9.10039 0.907253C9.33333 1.14849 9.33333 1.53675 9.33333 2.31328V3.42761" stroke="#222222" stroke-width="1.33333"/>
        <path d="M6.66669 13.333C5.76262 13.333 5.13452 13.3327 4.64813 13.2832C4.17416 13.235 3.90319 13.1452 3.69598 13.0107C3.52266 12.8982 3.36784 12.7596 3.237 12.5996C3.08067 12.4084 2.96193 12.1493 2.862 11.6836C2.75944 11.2056 2.68976 10.5812 2.59052 9.68262L1.92157 3.62012L11.4118 3.62012L10.7429 9.68262C10.6436 10.5812 10.5739 11.2056 10.4714 11.6836C10.3714 12.1492 10.2527 12.4085 10.0964 12.5996C9.96553 12.7596 9.81072 12.8982 9.63739 13.0107C9.43018 13.1452 9.15923 13.235 8.68524 13.2832C8.19885 13.3327 7.57073 13.333 6.66669 13.333Z" stroke="#222222" stroke-width="1.33333"/>
        <path d="M0.666687 3.41406H12.6667" stroke="#222222" stroke-width="1.33333" stroke-linecap="round"/>
      </svg>
  ...
  },
  {
    ...
    icon: `
      <svg width="6" height="2" viewBox="0 0 6 2" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M-0.000266552 0V1.65554H5.80371V0H-0.000266552Z" fill="#222222"/>
      </svg>
    `
  },
  {
    ...
    icon: `
      <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.06758 14C7.59256 14 8 13.5896 8 13.0688C8 12.8083 7.89814 12.5716 7.71792 12.3901L2.2331 6.99211L7.71792 1.60992C7.89814 1.42841 8 1.18377 8 0.931229C8 0.410372 7.59256 0 7.06758 0C6.81685 0 6.59745 0.0947012 6.42507 0.26832L0.329089 6.26607C0.109696 6.47125 0 6.72379 0 7C0 7.27621 0.109696 7.51297 0.321254 7.72604L6.41724 13.7317C6.59745 13.9053 6.81685 14 7.06758 14Z" fill="#1A1A1A"/>
      </svg>
    `
  },
  {
    ...
    icon: `
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_4993_97145)">
          <path d="M16 4.26628C16 4.63294 15.7 4.93294 15.3333 4.93294H0.666667C0.3 4.93294 0 4.63294 0 4.26628C0 3.89961 0.3 3.59961 0.666667 3.59961H15.3333C15.7 3.59961 16 3.89961 16 4.26628Z" fill="black"/>
          <path d="M12.667 7.33398H3.33366C2.96699 7.33398 2.66699 7.63398 2.66699 8.00065C2.66699 8.36732 2.96699 8.66732 3.33366 8.66732H12.667C13.0337 8.66732 13.3337 8.36732 13.3337 8.00065C13.3337 7.63398 13.0337 7.33398 12.667 7.33398Z" fill="black"/>
          <path d="M9.99967 11.0664H5.99967C5.63301 11.0664 5.33301 11.3664 5.33301 11.7331C5.33301 12.0997 5.63301 12.3997 5.99967 12.3997H9.99967C10.3663 12.3997 10.6663 12.0997 10.6663 11.7331C10.6663 11.3664 10.3663 11.0664 9.99967 11.0664Z" fill="black"/>
        </g>
        <defs>
